...
namespace daniel_roessner_gmx_de.logic.Modbus
{
    ...
    public class ModbusClientNode : LogicNodeBase
    {
        ...
        [Input(DisplayOrder = 10, InitOrder = 10, IsDefaultShown = false)]
        ...
        public ModbusClientNode(INodeContext context)
        {
            ...
            this.ModbusTX = typeService.CreateInt(PortTypes.Integer, "TX Wert",0);
        ...
        {
            if (ModbusHost.HasValue && ModbusTX.HasValue)
            {
